...
String pet= JOptionPane.showInputDialog("What kind of pet do you want? A dog, a cat, or a bunny?");
		// 7. REPEAT steps 3 - 6 enough times to make your pet happy!
			...
			int task = JOptionPane.showOptionDialog(null, "What do you want to do you make your pet happy?", "Making Your Dog Happy", 0, JOptionPane.INFORMATION_MESSAGE, null,
