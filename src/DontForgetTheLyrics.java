...
JOptionPane.showMessageDialog(null, "For this game, we will play part of a song, and you have to guess the rest of the lyrics to that part of the song.");
		// 5. Use the playSound method to play your song.

		// 6. Make a pop-up for the player to type their answer.
JOptionPane.showInputDialog("Type the lyrics here!");
